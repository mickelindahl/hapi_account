 ...
 *
 */
async function createOrLogin(social) {
    ...
    switch (social) {
        ...
        case 'google':
            url={
                ...
                login: options_ha.basePath + '/loginGoggle'
            };
            break;
    }
    ...
    return async (request, h)=>{
        ...
        try {
            ...
            const options_ha = request.server.plugins['hapi-account'].options_ha;
            ...
            if (!account) {
                ...
                options.payload={account_token:request.payload};
                options.url = url.create;
                await h.request.server.inject(options);
            ...
            return h.response(payload).header('Set-cookie', response.headers['Set-cookie'])
