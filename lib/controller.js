...
async function login(request, h) {
    ...
    try {
        ...
        //
        //     let now = new Date();
        //     duration = token.expire_at.valueOf() - now.valueOf();
        //
        // }else{
        ...
        // Remove previous token if existed
        if (current) {

            await request.pre.tokenDatabase.destroy({id: current.id})
