...
async function create( request, h ) {
    ...
    if(account.token){delete account.token}
...
// /**
//  *  Handler for getLoginStatus route
//  *
//  * - `request` hapi server request object
//  * - `h` [hapi response toolki](https://hapijs.com/api#response-toolkit)
//  *
...
//  *
//  */
// async function getLoginStatus(request, h) {
//
//     debug( 'getLoginStatus' );
//
//     let criteria = { id: request.pre.tokenEntry.account_id };
//
//     let account async request.pre.accountDatabase.findOne(criteria)
//
//     return h.response({user: account.user})
//
// }
