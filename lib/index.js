 ...
 *   - `authStrategyName` The server.auth.strategy schema name (hapi accunt used
 ...
 *     - `loginRenewTokenThreshold` Duration (in milliseconds) time for which token is automatically renewed calling on login
