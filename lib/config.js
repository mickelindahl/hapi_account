...
module.exports = (options) => {
    ...
    config.changePassword = {
        ...
        validate: {
            ...
            state: Joi.object().keys({
                [options.token_name]: Joi.string().description('Authentixation tooken. Can also be suplied as header Authentication'),
            }),
            headers: Joi.object({
    ...
    config.createOrLoginFacebook = {
        ...
        tags: ['api', 'account'],
        handler: (request, h)=>{}//controller.createOrLogin('facebook')
    };
    ...
    config.logout = {
        ...
        validate: {
            ...
            headers: Joi.object().keys({
                Authentication: Joi.string().description('Authentixation tooken. Can also be suplied as cookie'),
            })
        },
