...
module.exports = Joi.object({
    ...
    methods: Joi.array().items({
        type: Joi.string().valid(method_types).required(),
        method: Joi.func().required(),
    }).default([]).description('Methods to replace'),
    ...
    waterline: Joi.object().keys({
        ...
        models:Joi.object().description("Model collections received after orm initialization")
    })
